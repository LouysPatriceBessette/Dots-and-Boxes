...
export const tourPlayTranslation = {
  EN: {
    'Start play tour': 'How to play',
    'Start play tour title': 'How to play #1',
    'Start play tour description': 'You must play!',
  },
  FR: {
  ...
  ES: {
    ...
    'Start play tour title': 'Cómo jugar #1',
    'Start play tour description': '¡Debes jugar!',
  },
  DE: {
    'Start play tour': 'So spielt man',
    'Start play tour title': 'So spielt man #1',
    'Start play tour description': 'Du musst spielen!',
  },
  IT: {
    'Start play tour': 'Come giocare',
    'Start play tour title': 'Come giocare #1',
    'Start play tour description': 'Devi giocare!',
  },
  NL: {
    'Start play tour': 'Hoe te spelen',
    'Start play tour title': 'Hoe te spelen #1',
    'Start play tour description': 'Je moet spelen!',
  },
  RU: {
    'Start play tour': 'Как играть',
    'Start play tour title': 'Как играть #1',
    'Start play tour description': 'Вы должны играть!',
  },
  ZH: {
    'Start play tour': '怎么玩',
    'Start play tour title': '怎么玩 #1',
    'Start play tour description': '你必须玩！',
  },
  JA: {
    'Start play tour': 'プレイ方法',
    'Start play tour title': 'プレイ方法 #1',
    'Start play tour description': 'プレイする必要があります！',
  },
  KO: {
    'Start play tour': '게임 방법',
    'Start play tour title': '게임 방법 #1',
    'Start play tour description': '당신은 플레이해야 합니다!',
  },
  PT: {
    'Start play tour': 'Como jogar',
    'Start play tour title': 'Como jogar #1',
    'Start play tour description': 'Você deve jogar!',
  },
  HT: {
    'Start play tour': 'Kijan pou jwe',
    'Start play tour title': 'Kijan pou jwe #1',
    'Start play tour description': 'Ou dwe jwe!',
  },
}
